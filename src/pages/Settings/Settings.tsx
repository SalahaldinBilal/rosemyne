...
import { ArrowLeft, CloudUpload, Import, PictureInPicture2, RefreshCw, ScrollText, Settings2, Shapes, SquareSlash, Volume2 } from "lucide-solid";
...
const routes = [
  ...
  { path: "scrolling-capture", title: "Scrolling Capture", icon: ScrollText },
